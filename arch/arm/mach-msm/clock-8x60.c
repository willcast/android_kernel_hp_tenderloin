...
#ifndef CONFIG_REMOVE_SMI_2X_CLK
...
#ifdef CONFIG_REMOVE_SMI_2X_CLK
...
static struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_LOOKUP("core_clk",		gsbi10_uart_clk.c,	"msm_uartdm.1"),
...
#ifdef CONFIG_MACH_TENDERLOIN
	CLK_LOOKUP("core_clk",		gsbi12_qup_clk.c,	"qup_i2c.11"),
#else
...
#ifdef CONFIG_MACH_TENDERLOIN
	CLK_LOOKUP("iface_clk",		gsbi12_p_clk.c,		"qup_i2c.11"),
#else
	...
	CLK_LOOKUP("csi_clk",		csi1_clk.c, "msm_camera_mt9m113.0"),
	...
	CLK_LOOKUP("csi_vfe_clk",	csi1_vfe_clk.c, "msm_camera_mt9m113.0"),
	...
	CLK_LOOKUP("csi_pclk",		csi1_p_clk.c, "msm_camera_mt9m113.0"),
