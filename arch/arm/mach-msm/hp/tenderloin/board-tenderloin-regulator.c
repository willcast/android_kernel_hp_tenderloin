...
struct rpm_regulator_init_data rpm_regulator_init_data[] __devinitdata = {
...
struct rpm_regulator_platform_data tenderloin_rpm_regulator_pdata __devinitdata = {
	.init_data		= rpm_regulator_init_data,
	.num_regulators		= ARRAY_SIZE(rpm_regulator_init_data),
	.version		= RPM_VREG_VERSION_8660,
};

struct rpm_regulator_platform_data tenderloin_rpm_regulator_early_pdata __devinitdata = {
